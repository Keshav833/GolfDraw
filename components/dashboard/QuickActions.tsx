          ...
          return (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="block text-sm font-medium text-[#2a3a2a]">
                  {action.label}
                </span>
                <span className="mt-0.5 block text-[10px] text-[#6a7a6a]">
                  {action.sublabel}
                </span>
              </span>
              <span
                className="text-base text-[#9aaa9a]"
                style={{ textShadow: raisedXs }}
              >
                ›
              </span>
            </Link>
