...
async function setupAdmin() {
  if (!supabaseUrl || !supabaseServiceKey || !adminEmail || !adminPassword) {
    ...
    console.log({ supabaseUrl: !!supabaseUrl, supabaseServiceKey: !!supabaseServiceKey, adminEmail, adminPassword })
    process.exit(1)
  }
  ...
  if (dbError) {
    console.warn('Warning: Could not upsert into public.users:', dbError.message)
  }
