...
export default function AdminLoginPage({
  ...
  return (
    <main
      ...
      style={{
        background: 'linear-gradient(145deg, #0a1f10 0%, #0f2d18 40%, #091a0f 100%)',
      }}
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(26,94,56,0.35) 0%, transparent 70%)',
          filter: 'blur(40px)',
        }}
      />
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(125,224,170,0.1) 0%, transparent 70%)',
          filter: 'blur(50px)',
        }}
      />
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(15,61,36,0.2) 0%, transparent 60%)',
          filter: 'blur(60px)',
        }}
      />
