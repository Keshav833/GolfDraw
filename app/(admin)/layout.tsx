      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-64 flex-shrink-0 flex flex-col border-r border-[var(--sd)] bg-[var(--bg)] p-6">
          <div className="flex items-center gap-3 mb-10">
            ...
            <span className="text-2xl font-serif text-[var(--text)]">Admin</span>
          </div>

          <nav className="flex-1 space-y-4">
            <SidebarItem href="/admin" icon={<LayoutGrid size={20} />} label="Overview" />
            <SidebarItem href="/admin/users" icon={<Users size={20} />} label="Users" />
            <SidebarItem href="/admin/draws" icon={<Trophy size={20} />} label="Draws" />
            <SidebarItem href="/admin/winners" icon={<ShieldCheck size={20} />} label="Winners" />
            <SidebarItem href="/admin/charities" icon={<Heart size={20} />} label="Charities" />
          </nav>
