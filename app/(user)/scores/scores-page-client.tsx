        ...
        <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            <div className="mb-5">
              ...
              <h2 className="mt-2 text-xl font-semibold text-[#2a3a2a]">Add your latest round</h2>
              <p className="mt-1 text-sm text-[#6a7a6a]">
                Enter a score between 1 and 45. Your newest score is highlighted automatically.
              </p>
            </div>
          ...
          >
            <div className="mb-5">
              ...
              <h2 className="mt-2 text-xl font-semibold text-[#2a3a2a]">Recent scores</h2>
              <p className="mt-1 text-sm text-[#6a7a6a]">
